...
```sh
El uso los datos desde API es para exclusivo uso personal. Todos los derechos a su fuente https://rawg.io/. 
Se recomienda la obtención de API key en su página web oficial: https://rawg.io/apidocs.
```
